...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 726.0, 126.0, 61.0, 22.0 ],
					"text" : "delay 240"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "42 33 38 43 42 34 39 35 31 42 30 42 43 37 44 46 46 31 46 44 38 40 40 35"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 299.0, 449.0, 32.0, 22.0 ],
									"text" : "print"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 359.0, 433.0, 41.0, 22.0 ],
									"text" : "s note"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 186.0, 335.0, 22.0, 22.0 ],
									"text" : "t b"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 348.0, 357.0, 31.0, 22.0 ],
									"text" : "int 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 223.0, 286.0, 34.0, 22.0 ],
									"text" : "sel 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 183.0, 253.0, 61.0, 22.0 ],
									"text" : "counter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 225.0, 195.0, 51.0, 22.0 ],
									"text" : "zl.mth 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.0, 50.0, 43.0, 22.0 ],
									"text" : "r clock"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 225.0, 150.0, 38.0, 22.0 ],
									"text" : "zl.reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 4,
									"outlettype" : [ "int", "", "", "int" ],
									"patching_rect" : [ 310.0, 150.0, 61.0, 22.0 ],
									"text" : "counter 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 244.0, 19.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 171.5, 423.0, 30.0, 30.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 195.5, 360.0, 333.0, 360.0, 333.0, 351.0, 357.5, 351.0 ],
									"source" : [ "obj-27", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 693.0, 187.0, 46.0, 22.0 ],
					"text" : "s clock"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 626.0, 373.0, 49.0, 22.0 ],
									"text" : "noteout"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 322.0, 373.0, 49.0, 22.0 ],
									"text" : "noteout"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 3,
									"numoutlets" : 0,
									"patching_rect" : [ 31.5, 377.0, 49.0, 22.0 ],
									"text" : "noteout"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 628.0, 260.0, 118.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "float", "float", "float" ],
									"patching_rect" : [ 329.0, 265.0, 118.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "float", "float", "float" ],
									"patching_rect" : [ 26.0, 275.0, 118.0, 22.0 ],
...
,
					"patching_rect" : [ 791.0, 60.0, 41.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 145.0, 61.0, 292.0, 134.0 ],
					"setminmax" : [ 1.0, 8.0 ],
					"settype" : 0,
					"size" : 4
				}
